...
public class Stepdefs {
    ...
    public void tooShortUsernameAndCorrectPasswordAndMatchingPasswordConfirmationAreEntered(String username, String password) {
        registerWith(username, password, password);
    }
    ...
    @When("too short username {string} and correct password {string} and non-matching password confirmation are entered")
    public void tooShortUsernameAndCorrectPasswordAndNonMatchingPasswordConfirmationAreEntered(String username, String password) {
        registerWith(username, password, password + "12");
    ...
    private void registerWith(String username, String password, String confpassword) {
